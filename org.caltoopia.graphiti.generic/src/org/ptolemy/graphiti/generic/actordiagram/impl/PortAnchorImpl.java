 ...
 * <ul>
 *   <li>{@link org.ptolemy.graphiti.generic.actordiagram.impl.PortAnchorImpl#getAlignment <em>Alignment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PortAnchorImpl extends BoxRelativeAnchorImpl implements PortAnchor {
	/**
	...
	protected EClass eStaticClass() {
		return ActordiagramPackage.Literals.PORT_ANCHOR;
	}
	...
	public void setAlignment(Orientation newAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActordiagramPackage.PORT_ANCHOR__ALIGNMENT, oldAlignment, alignment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActordiagramPackage.PORT_ANCHOR__ALIGNMENT:
				return getAlignment();
		}
