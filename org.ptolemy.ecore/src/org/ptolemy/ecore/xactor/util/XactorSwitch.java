 ...
 * @generated
 */
public class XactorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XactorPackage.ENTITY_FOLDER: {
				...
				if (result == null) result = caseEntityContainer(entityFolder);
				if (result == null) result = caseNamedObj(entityFolder);
				if (result == null) result = caseIEntity(entityFolder);
				if (result == null) result = caseNameable(entityFolder);
				if (result == null) result = caseNamed(entityFolder);
