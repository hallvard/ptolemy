...
public class AbstractRemoveLinkFeature extends DefaultRemoveFeature {
	...
	public static boolean isUnlinked(IPictogramElementContext context, ILinkService linkService) {
		return isUnlinked(context.getPictogramElement(), linkService);
	}

	public static boolean isUnlinked(PictogramElement pe, ILinkService linkService) {
		return (pe instanceof Shape && isUnlinked((Shape) pe, linkService));
	}

	public static boolean isUnlinked(Shape shape, ILinkService linkService) {
		return isUnlinked(linkService.getBusinessObjectForLinkedPictogramElement(shape));
	}

	private static boolean isUnlinked(EObject model) {
