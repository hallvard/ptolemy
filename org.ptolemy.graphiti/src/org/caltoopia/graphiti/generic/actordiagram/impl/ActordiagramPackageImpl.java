...
import org.caltoopia.graphiti.generic.actordiagram.ActordiagramFactory;
...
import org.caltoopia.graphiti.generic.actordiagram.EntityContainerShape;
...
import org.caltoopia.graphiti.generic.actordiagram.PortAnchor;
import org.caltoopia.graphiti.generic.actordiagram.PortGA;
import org.caltoopia.graphiti.generic.actordiagram.PortShape;
import org.caltoopia.graphiti.generic.actordiagram.RelationConnection;
...
public class ActordiagramPackageImpl extends EPackageImpl implements ActordiagramPackage {
	 ...
	 * @see org.caltoopia.graphiti.generic.actordiagram.ActordiagramPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		ETypeParameter entityShapeEClass_M = addETypeParameter(entityShapeEClass, "M");
		ETypeParameter entityContainerShapeEClass_M = addETypeParameter(entityContainerShapeEClass, "M");
		ETypeParameter portShapeEClass_M = addETypeParameter(portShapeEClass, "M");
		ETypeParameter portGAEClass_M = addETypeParameter(portGAEClass, "M");
		ETypeParameter relationConnectionEClass_M = addETypeParameter(relationConnectionEClass, "M");
		ETypeParameter relationShapeEClass_M = addETypeParameter(relationShapeEClass, "M");
		ETypeParameter entityContainerDiagramEClass_M = addETypeParameter(entityContainerDiagramEClass, "M");
		...
		EGenericType g2 = createEGenericType(entityShapeEClass_M);
		...
		g1 = createEGenericType(this.getModelShape());
		g2 = createEGenericType(entityContainerShapeEClass_M);
		g1.getETypeArguments().add(g2);
		entityContainerShapeEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getLabelShape());
		entityContainerShapeEClass.getEGenericSuperTypes().add(g1);
		...
		g1 = createEGenericType(this.getModelShape());
		g2 = createEGenericType(portShapeEClass_M);
		g1.getETypeArguments().add(g2);
		portShapeEClass.getEGenericSuperTypes().add(g1);
		...
		EOperation op = addEOperation(portGAEClass, null, "getPortShape", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(this.getPortShape());
		g2 = createEGenericType(portGAEClass_M);
		g1.getETypeArguments().add(g2);
