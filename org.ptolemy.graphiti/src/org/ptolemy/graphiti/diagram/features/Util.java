...
public class Util {
	...
	public static Shape getParentShape(PictogramElement pe, Class<?> c) {
		...
		while (pe instanceof Shape) {
	        ...
	        if (c.isInstance(bo) && (result == null || bo == linkService.getBusinessObjectForLinkedPictogramElement(result))) {
	        	result = shape;
	        } else if (result != null) {
	        	break;
	        }
