...
import org.ptolemy.xtext.ui.custom.SelectionLimitingXtextSourceViewer;
...
public abstract class AbstractEditAsTextHelper implements IEditAsTextHelper, IEditedResourceProvider {
	...
	protected XtextResource createXtextResource(EObject semanticElement) {
		IResourceFactory resourceFactory = context.getInjector().getInstance(IResourceFactory.class);
    ...
    protected String createXtextEditor() {
		...
		EmbeddedEditorFactory embeddedEditorFactory = context.getInjector().getInstance(EmbeddedEditorFactory.class);
