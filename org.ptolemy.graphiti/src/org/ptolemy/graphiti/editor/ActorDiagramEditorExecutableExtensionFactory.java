 ...
 * introduced subclass. 
 */
public class ActorDiagramEditorExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		try {
			...
			Class<?> c = Activator.getDefault().getBundle().loadClass(className);
			...
			throw new CoreException(new Status(IStatus.ERROR, Activator.PLUGIN_ID, e.getMessage() + " ExtensionFactory: "+ getClass().getName(), e));
		}
	}
}
