...
import org.ptolemy.graphiti.views.GraphicsEditorOutlinePage;
...
//		return (pos >= 0 && pos < actorDiagramEditors.size() ? actorDiagramEditors.get(pos) : null);
	}
	...
	protected void createPages() {
		try {
			...
			setPartName(getMainEditor().getPartName());
	...
	private GraphicsEditorOutlinePage outlinePage = null;
	
	private GraphicsEditorOutlinePage getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new GraphicsEditorOutlinePage(this);
		}
		return outlinePage;
	}
}
