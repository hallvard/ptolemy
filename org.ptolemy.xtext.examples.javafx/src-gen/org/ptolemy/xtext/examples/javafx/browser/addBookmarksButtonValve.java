...
public class addBookmarksButtonValve extends PButtonValve<URL> {
  ...
  protected String _initialIdAttributeValue() throws IllegalActionException {
    ...
    return "browser_bookmarks_addButton"; 
  }
  ...
  public addBookmarksButtonValve(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "addBookmarksButtonValve");
