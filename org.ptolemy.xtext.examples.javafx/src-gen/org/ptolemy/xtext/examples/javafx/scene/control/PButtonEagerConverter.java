...
public abstract class PButtonEagerConverter<T, S> extends AbstractCaltropActor {
  ...
  protected abstract Token _createValidatorToken(final Function1<? super S,? extends Boolean> validator) throws IllegalActionException;
  
  protected Function1<? super S,? extends Boolean> _initialValidatorAttributeValue() throws IllegalActionException {
    return null; 
  }
  
  protected abstract Function1<? super S,? extends Boolean> _getValidatorValue() throws IllegalActionException;
  
  protected void _setValidatorValue(final Function1<? super S,? extends Boolean> validator) throws IllegalActionException {
  ...
  public PButtonEagerConverter(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
  ...
  public PButtonEagerConverter(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "PButtonEagerConverter");
  ...
  private S old_current;
  
  private S _initialCurrentStateVariableValue() throws IllegalActionException {
    return null; 
  }
  ...
  public void _preChangeCurrentState(final S current) throws IllegalActionException {
  ...
  public void _postChangeCurrentState(final S current) throws IllegalActionException {
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public boolean match() throws IllegalActionException {
      if (! hasToken(PButtonEagerConverter.this.input, 0, 1)) return false;
      input = _getInputTokenValue(PButtonEagerConverter.this.input.get(0));
      return true; 
    }
    ...
    public void body() throws IllegalActionException {
      ...
      try {
        S _apply = _getFunValue().apply(this.input);
        PButtonEagerConverter.this.current = _apply;
        boolean _isValid = PButtonEagerConverter.this.isValid();
        PButtonEagerConverter.this.enabled = _isValid;
      } catch (final Throwable _t) {
        if (_t instanceof Exception) {
          final Exception e = (Exception)_t;
          PButtonEagerConverter.this.current = null;
        } else {
  ...
  public class Actions1 extends AbstractActionImpl {
    ...
    public void output() throws IllegalActionException {
      if (_outputPattern0Guard()) {
        ...
        send(PButtonEagerConverter.this.output, 0, _createOutputToken(_value), -1);
    ...
    private S _outputPattern0Output0() throws IllegalActionException {
      return PButtonEagerConverter.this.current; 
    }
    
    private boolean _outputPattern0Guard() throws IllegalActionException {
      
      boolean _isValid = PButtonEagerConverter.this.isValid();return _isValid; 
    }
