...
import org.ptolemy.xtext.tests.gui.BeanContainerAttribute;
import org.ptolemy.xtext.tests.gui.Util;
...
public class SwixmlResource extends BeanContainerAttribute {

    private StringParameter swixmlResourceParameter;
    
    public SwixmlResource(NamedObj container, String name) throws IllegalActionException, NameDuplicationException {
        super(container, name);
        swixmlResourceParameter = new StringParameter(this, "swixmlResource");
    }
    ...
    public void initialize() throws IllegalActionException {
        ...
        String swixmlResource = Util.getStringParameterValue(swixmlResourceParameter);
        try {
            URL url = new URL(swixmlResource.indexOf(':') > 2 ? swixmlResource : "file://" + swixmlResource);
            Container container = swingEngine.render(url);
            ...
            throw new IllegalActionException(this, e, "Couldn't render" + swixmlResource);
        }
    }
    ...
    @Override
    public Object getBean(String idOrPath) {
