...
import hal.caltrop.actors.variants.DoubleRepeatMulti1int1intImpl;
...
public class DoubleRepeatMulti1int1int extends AbstractCaltropActor {
  ...
  public DoubleRepeatMulti1int1int(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    ...
    this._impl = new DoubleRepeatMulti1int1intImpl(this, input, output); 
  }
  
  private final DoubleRepeatMulti1int1intImpl _impl;
  
  protected DoubleRepeatMulti1int1intImpl _getImpl() {
    return _impl;
