...
import hal.caltrop.actors.variants.SingleRepeat1int3intImpl;
...
public class SingleRepeat1int3int extends AbstractCaltropActor {
  ...
  public SingleRepeat1int3int(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    ...
    this._impl = new SingleRepeat1int3intImpl(this, input, output); 
  }
  
  private final SingleRepeat1int3intImpl _impl;
  
  protected SingleRepeat1int3intImpl _getImpl() {
    return _impl;
