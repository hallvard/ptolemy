...
public class doubleRepeat1int1int extends AbstractCaltropActor {
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public boolean match() throws IllegalActionException {
      ...
      if (! hasToken(doubleRepeat1int1int.this.input, 0, _inputRepeat * 2)) return false;
      Token[] _inputArray = doubleRepeat1int1int.this.input.get(0, _inputRepeat * 2);
      i1 = IntTokens.copyInto(_inputArray, 2, 0, new int[_inputRepeat]);
      i2 = IntTokens.copyInto(_inputArray, 2, 1, new int[_inputRepeat]);
      return true; 
    }
    ...
    public void output() throws IllegalActionException {
      ...
      send(doubleRepeat1int1int.this.output, 0, _tokenArray, -1);
    ...
    public Pair<Pair<IOPort,IOPort>,Dependency>[] getDependencies() {
      return new Pair[]{
        new Pair.Impl(new Pair.Impl(doubleRepeat1int1int.this.input, doubleRepeat1int1int.this.output), BooleanDependency.valueOf(true)), 
      };
