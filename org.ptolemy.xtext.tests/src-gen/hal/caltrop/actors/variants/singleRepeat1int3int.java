...
public class singleRepeat1int3int extends AbstractCaltropActor {
  ...
  public singleRepeat1int3int(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public boolean match() throws IllegalActionException {
      ...
      if (! hasToken(singleRepeat1int3int.this.input, 0, _inputRepeat * 1)) return false;
      Token[] _inputArray = singleRepeat1int3int.this.input.get(0, _inputRepeat * 1);
    ...
    public void output() throws IllegalActionException {
      ...
      send(singleRepeat1int3int.this.output, 0, new IntToken[]{
    ...
    private int _outputPattern0Output0() throws IllegalActionException {
      ...
      int _index = this.i[0];return _index; 
    }
    
    private int _outputPattern0Output1() throws IllegalActionException {
      
      int _index = this.i[1];return _index; 
    }
    
    private int _outputPattern0Output2() throws IllegalActionException {
      
      int _index = this.i[2];return _index; 
    }
    
    public Pair<Pair<IOPort,IOPort>,Dependency>[] getDependencies() {
      return new Pair[]{
        new Pair.Impl(new Pair.Impl(singleRepeat1int3int.this.input, singleRepeat1int3int.this.output), BooleanDependency.valueOf(true)), 
      };
