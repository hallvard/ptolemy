package org.ptolemy.xtext.browser;

import org.ptolemy.xtext.browser.browser.addBookmarksButtonValve;
import org.ptolemy.xtext.browser.browser.bookmarks;
import org.ptolemy.xtext.browser.browser.bookmarksList;
import org.ptolemy.xtext.browser.browser.browserPane;
import org.ptolemy.xtext.browser.browser.location;
import org.ptolemy.xtext.browser.browser.locationText;
import org.ptolemy.xtext.browser.browser.relations0;
import org.ptolemy.xtext.browser.browser.string2Url;
...
public class Browser extends TypedCompositeActor {
  ...
  public Browser(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    ...
    this.bookmarks.getPort("addBookmark").link(r9);
