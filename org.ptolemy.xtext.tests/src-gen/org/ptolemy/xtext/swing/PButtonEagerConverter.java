...
public abstract class PButtonEagerConverter<T, S> extends AbstractCaltropActor {
  ...
  public void _preChangeCurrentState(final S current) {
  ...
  public void _postChangeCurrentState(final S current) {
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public boolean update() throws IllegalActionException {
      ...
      boolean _xblockexpression = false;
      {
        ...
        PButtonEagerConverter.this.button.setEnabled(_isValid);
