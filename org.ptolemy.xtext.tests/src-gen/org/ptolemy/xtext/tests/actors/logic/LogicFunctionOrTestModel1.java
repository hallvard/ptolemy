...
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel1.logicFunction;
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel1.logicFunctionTest;
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel1.values;
...
public class LogicFunctionOrTestModel1 extends TypedCompositeActor {
  ...
  public LogicFunctionOrTestModel1(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
  ...
  public LogicFunctionOrTestModel1(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "LogicFunctionOrTestModel1");
