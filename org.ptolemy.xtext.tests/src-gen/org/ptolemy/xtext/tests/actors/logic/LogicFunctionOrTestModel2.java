...
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel2.logicFunction;
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel2.logicFunctionTest;
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel2.values1;
import org.ptolemy.xtext.tests.actors.logic.logicFunctionOrTestModel2.values2;
...
public class LogicFunctionOrTestModel2 extends TypedCompositeActor {
  ...
  public LogicFunctionOrTestModel2(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
