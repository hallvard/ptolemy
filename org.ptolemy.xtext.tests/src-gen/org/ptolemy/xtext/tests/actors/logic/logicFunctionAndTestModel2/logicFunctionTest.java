...
public class logicFunctionTest extends TestValues<Boolean> {
  ...
  protected Iterable<Boolean> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Boolean>unmodifiableList(Lists.<Boolean>newArrayList(Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true))); 
  }
