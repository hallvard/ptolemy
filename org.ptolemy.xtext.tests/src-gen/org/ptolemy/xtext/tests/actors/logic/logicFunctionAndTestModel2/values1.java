package org.ptolemy.xtext.tests.actors.logic.logicFunctionAndTestModel2;
...
public class values1 extends Values<Boolean> {
  ...
  protected Iterable<Boolean> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Boolean>unmodifiableList(Lists.<Boolean>newArrayList(Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(true))); 
  }
  
  public values1(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
    
  }
  
  public values1(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "values1");
