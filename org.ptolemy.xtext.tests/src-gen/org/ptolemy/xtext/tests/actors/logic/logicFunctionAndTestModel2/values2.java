...
public class values2 extends Values<Boolean> {
  ...
  protected Iterable<Boolean> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Boolean>unmodifiableList(Lists.<Boolean>newArrayList(Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(true))); 
  }
  
  public values2(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
