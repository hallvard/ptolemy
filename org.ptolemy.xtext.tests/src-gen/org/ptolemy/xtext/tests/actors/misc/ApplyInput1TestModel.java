...
import org.ptolemy.xtext.tests.actors.misc.applyInput1TestModel.applyInput;
import org.ptolemy.xtext.tests.actors.misc.applyInput1TestModel.applyInputTest;
import org.ptolemy.xtext.tests.actors.misc.applyInput1TestModel.values;
...
public class ApplyInput1TestModel extends TypedCompositeActor {
  ...
  public ApplyInput1TestModel(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
  ...
  public ApplyInput1TestModel(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "ApplyInput1TestModel");
