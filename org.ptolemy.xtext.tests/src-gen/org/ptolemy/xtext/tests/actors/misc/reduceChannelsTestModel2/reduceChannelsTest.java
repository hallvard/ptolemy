package org.ptolemy.xtext.tests.actors.misc.reduceChannelsTestModel2;
...
public class reduceChannelsTest extends TestValues<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(10), Integer.valueOf(12))); 
  }
  
  public reduceChannelsTest(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
