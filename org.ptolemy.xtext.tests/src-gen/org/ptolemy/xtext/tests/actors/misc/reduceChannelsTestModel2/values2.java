...
public class values2 extends Values<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(9), Integer.valueOf(10))); 
  }
