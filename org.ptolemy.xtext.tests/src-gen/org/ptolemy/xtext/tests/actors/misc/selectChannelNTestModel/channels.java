...
public class channels extends Values<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(0), Integer.valueOf(2), Integer.valueOf(1))); 
  }
  
  public channels(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
