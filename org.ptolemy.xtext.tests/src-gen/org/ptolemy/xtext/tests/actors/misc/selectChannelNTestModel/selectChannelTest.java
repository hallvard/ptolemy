...
public class selectChannelTest extends TestValues<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(1), Integer.valueOf(10), Integer.valueOf(6))); 
  }
  
  public selectChannelTest(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
