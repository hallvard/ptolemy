...
public class values3 extends Values<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(9), Integer.valueOf(10), Integer.valueOf(11))); 
  }
  
  public values3(final CompositeEntity parent, final String name) throws NameDuplicationException, IllegalActionException {
    super(parent, name);
    
  }
  
  public values3(final CompositeEntity parent) throws NameDuplicationException, IllegalActionException {
    this(parent, "values3");
