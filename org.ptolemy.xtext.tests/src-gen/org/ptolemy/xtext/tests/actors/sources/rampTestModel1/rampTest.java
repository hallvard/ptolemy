...
public class rampTest extends AbstractTest {
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public void body() throws IllegalActionException {
      ...
      String _plus = ("input should be == " + Integer.valueOf(rampTest.this.step));
      rampTest.this.assertEquals(_plus, rampTest.this.step, this.i);
  ...
  public class Actions1 extends AbstractActionImpl {
    ...
    public void body() throws IllegalActionException {
      ...
      String _plus = ("Step " + Integer.valueOf(rampTest.this.step));
      String _plus_1 = (_plus + ": default action");
      rampTest.this.fail(_plus_1);
