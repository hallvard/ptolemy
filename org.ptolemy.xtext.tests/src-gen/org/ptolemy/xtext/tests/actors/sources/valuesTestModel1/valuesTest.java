package org.ptolemy.xtext.tests.actors.sources.valuesTestModel1;
...
public class valuesTest extends AbstractTest {
  ...
  public class Actions0 extends AbstractActionImpl {
    ...
    public void body() throws IllegalActionException {
      ...
      boolean _lessThan = (valuesTest.this.step < 3);
      valuesTest.this.assertTrue("Step should be < 3", _lessThan);
      String _plus = ("input should be " + Integer.valueOf(valuesTest.this.step));
      valuesTest.this.assertEquals(_plus, valuesTest.this.step, this.i);
  ...
  public class Actions1 extends AbstractActionImpl {
    ...
    public void body() throws IllegalActionException {
      ...
      valuesTest.this.fail("Stop when step >= 3");
