...
public class values extends Values<Integer> {
  ...
  protected Iterable<Integer> _initialValuesAttributeValue() throws IllegalActionException {
    ...
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(0), Integer.valueOf(1), Integer.valueOf(2))); 
  }
  
  protected boolean _initialRepAttributeValue() throws IllegalActionException {
