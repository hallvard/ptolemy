	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getEntityFolderAccess().getAlternatives_6(), "rule__EntityFolder__Alternatives_6");
					put(grammarAccess.getEntityAccess().getAlternatives(), "rule__Entity__Alternatives");
					put(grammarAccess.getInstanceParameterBindingAccess().getValueExpressionAlternatives_1_0(), "rule__InstanceParameterBinding__ValueExpressionAlternatives_1_0");
					put(grammarAccess.getCompositeEntityAccess().getAlternatives_0(), "rule__CompositeEntity__Alternatives_0");
					...
					put(grammarAccess.getPortAccess().getAlternatives_0(), "rule__Port__Alternatives_0");
					put(grammarAccess.getAtomicActorImplAccess().getAlternatives(), "rule__AtomicActorImpl__Alternatives");
					put(grammarAccess.getAbstractEntityActorImplAccess().getAlternatives_1(), "rule__AbstractEntityActorImpl__Alternatives_1");
					put(grammarAccess.getCaltropActorImplAccess().getAlternatives_2(), "rule__CaltropActorImpl__Alternatives_2");
					put(grammarAccess.getStateVariableAccess().getAlternatives_0(), "rule__StateVariable__Alternatives_0");
					...
					put(grammarAccess.getIOPortKindAccess().getAlternatives(), "rule__IOPortKind__Alternatives");
					...
					put(grammarAccess.getInstanceParameterBindingAccess().getGroup(), "rule__InstanceParameterBinding__Group__0");
					put(grammarAccess.getInstanceParameterBindingAccess().getGroup_0(), "rule__InstanceParameterBinding__Group_0__0");
					put(grammarAccess.getInstanceActorRefAccess().getGroup(), "rule__InstanceActorRef__Group__0");
					put(grammarAccess.getInstanceActorRefAccess().getGroup_1(), "rule__InstanceActorRef__Group_1__0");
					put(grammarAccess.getInstanceActorRefAccess().getGroup_1_2(), "rule__InstanceActorRef__Group_1_2__0");
					...
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_0(), "rule__CompositeEntity__Group_0_0__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_0_3(), "rule__CompositeEntity__Group_0_0_3__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1(), "rule__CompositeEntity__Group_0_1__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0(), "rule__CompositeEntity__Group_0_1_0__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_4(), "rule__CompositeEntity__Group_0_1_0_4__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_4_2(), "rule__CompositeEntity__Group_0_1_0_4_2__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_5(), "rule__CompositeEntity__Group_0_1_0_5__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_5_2(), "rule__CompositeEntity__Group_0_1_0_5_2__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_6(), "rule__CompositeEntity__Group_0_1_0_6__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_6_0(), "rule__CompositeEntity__Group_0_1_0_6_0__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_6_0_1(), "rule__CompositeEntity__Group_0_1_0_6_0_1__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_6_2(), "rule__CompositeEntity__Group_0_1_0_6_2__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_0_6_2_1(), "rule__CompositeEntity__Group_0_1_0_6_2_1__0");
					put(grammarAccess.getCompositeEntityAccess().getGroup_0_1_1(), "rule__CompositeEntity__Group_0_1_1__0");
					put(grammarAccess.getInjectableAttributeAccess().getGroup(), "rule__InjectableAttribute__Group__0");
					put(grammarAccess.getVariableAccess().getGroup(), "rule__Variable__Group__0");
					put(grammarAccess.getVariableAccess().getGroup_0_1(), "rule__Variable__Group_0_1__0");
					...
					put(grammarAccess.getActorParameterAccess().getGroup_3(), "rule__ActorParameter__Group_3__0");
					...
					put(grammarAccess.getPlainPortAccess().getGroup(), "rule__PlainPort__Group__0");
					put(grammarAccess.getTypedIOPortAccess().getGroup(), "rule__TypedIOPort__Group__0");
					put(grammarAccess.getTypedIOPortAccess().getGroup_2(), "rule__TypedIOPort__Group_2__0");
					...
					put(grammarAccess.getAbstractEntityActorImplAccess().getGroup(), "rule__AbstractEntityActorImpl__Group__0");
					put(grammarAccess.getAbstractEntityActorImplAccess().getGroup_1_0(), "rule__AbstractEntityActorImpl__Group_1_0__0");
					put(grammarAccess.getAbstractEntityActorImplAccess().getGroup_1_1(), "rule__AbstractEntityActorImpl__Group_1_1__0");
					put(grammarAccess.getAbstractEntityActorImplAccess().getGroup_1_1_2(), "rule__AbstractEntityActorImpl__Group_1_1_2__0");
					put(grammarAccess.getCaltropActorImplAccess().getGroup(), "rule__CaltropActorImpl__Group__0");
					put(grammarAccess.getCaltropActorImplAccess().getGroup_2_0(), "rule__CaltropActorImpl__Group_2_0__0");
					put(grammarAccess.getStateVariableAccess().getGroup(), "rule__StateVariable__Group__0");
					put(grammarAccess.getStateVariableAccess().getGroup_3(), "rule__StateVariable__Group_3__0");
					...
					put(grammarAccess.getActorModelAccess().getImportsAssignment_4(), "rule__ActorModel__ImportsAssignment_4");
					put(grammarAccess.getActorModelAccess().getAttributesAssignment_5(), "rule__ActorModel__AttributesAssignment_5");
					put(grammarAccess.getActorModelAccess().getEntityContainersAssignment_6(), "rule__ActorModel__EntityContainersAssignment_6");
					put(grammarAccess.getActorModelAccess().getEntitiesAssignment_7(), "rule__ActorModel__EntitiesAssignment_7");
					put(grammarAccess.getActorModelAccess().getRelationsAssignment_8(), "rule__ActorModel__RelationsAssignment_8");
					put(grammarAccess.getEntityFolderAccess().getNameAssignment_2(), "rule__EntityFolder__NameAssignment_2");
					put(grammarAccess.getEntityFolderAccess().getDisplayNameAssignment_3(), "rule__EntityFolder__DisplayNameAssignment_3");
					put(grammarAccess.getEntityFolderAccess().getAttributesAssignment_4(), "rule__EntityFolder__AttributesAssignment_4");
					put(grammarAccess.getEntityFolderAccess().getEntitiesAssignment_6_0(), "rule__EntityFolder__EntitiesAssignment_6_0");
					put(grammarAccess.getEntityFolderAccess().getEntityContainersAssignment_6_1(), "rule__EntityFolder__EntityContainersAssignment_6_1");
					...
					put(grammarAccess.getTypedAtomicActorAccess().getPortsAssignment_8(), "rule__TypedAtomicActor__PortsAssignment_8");
					put(grammarAccess.getTypedAtomicActorAccess().getAttributesAssignment_9(), "rule__TypedAtomicActor__AttributesAssignment_9");
					put(grammarAccess.getTypedAtomicActorAccess().getImplAssignment_10(), "rule__TypedAtomicActor__ImplAssignment_10");
					...
					put(grammarAccess.getInstanceParameterBindingAccess().getParameterRefAssignment_0_0(), "rule__InstanceParameterBinding__ParameterRefAssignment_0_0");
					put(grammarAccess.getInstanceParameterBindingAccess().getValueExpressionAssignment_1(), "rule__InstanceParameterBinding__ValueExpressionAssignment_1");
					put(grammarAccess.getInstanceActorRefAccess().getRefAssignment_0(), "rule__InstanceActorRef__RefAssignment_0");
					put(grammarAccess.getInstanceActorRefAccess().getParameterBindingsAssignment_1_1(), "rule__InstanceActorRef__ParameterBindingsAssignment_1_1");
					put(grammarAccess.getInstanceActorRefAccess().getParameterBindingsAssignment_1_2_1(), "rule__InstanceActorRef__ParameterBindingsAssignment_1_2_1");
					put(grammarAccess.getTypedAtomicActorInstanceAccess().getNameAssignment_2(), "rule__TypedAtomicActorInstance__NameAssignment_2");
					put(grammarAccess.getTypedAtomicActorInstanceAccess().getDisplayNameAssignment_3(), "rule__TypedAtomicActorInstance__DisplayNameAssignment_3");
					put(grammarAccess.getTypedAtomicActorInstanceAccess().getSuperEntityAssignment_5(), "rule__TypedAtomicActorInstance__SuperEntityAssignment_5");
					put(grammarAccess.getCompositeEntityAccess().getNameAssignment_0_0_1(), "rule__CompositeEntity__NameAssignment_0_0_1");
					put(grammarAccess.getCompositeEntityAccess().getDisplayNameAssignment_0_0_2(), "rule__CompositeEntity__DisplayNameAssignment_0_0_2");
					put(grammarAccess.getCompositeEntityAccess().getSuperEntityAssignment_0_0_3_1(), "rule__CompositeEntity__SuperEntityAssignment_0_0_3_1");
					put(grammarAccess.getCompositeEntityAccess().getNameAssignment_0_1_0_2(), "rule__CompositeEntity__NameAssignment_0_1_0_2");
					put(grammarAccess.getCompositeEntityAccess().getDisplayNameAssignment_0_1_0_3(), "rule__CompositeEntity__DisplayNameAssignment_0_1_0_3");
					put(grammarAccess.getCompositeEntityAccess().getTypeParametersAssignment_0_1_0_4_1(), "rule__CompositeEntity__TypeParametersAssignment_0_1_0_4_1");
					put(grammarAccess.getCompositeEntityAccess().getTypeParametersAssignment_0_1_0_4_2_1(), "rule__CompositeEntity__TypeParametersAssignment_0_1_0_4_2_1");
					put(grammarAccess.getCompositeEntityAccess().getAttributesAssignment_0_1_0_5_1(), "rule__CompositeEntity__AttributesAssignment_0_1_0_5_1");
					put(grammarAccess.getCompositeEntityAccess().getAttributesAssignment_0_1_0_5_2_1(), "rule__CompositeEntity__AttributesAssignment_0_1_0_5_2_1");
					put(grammarAccess.getCompositeEntityAccess().getPortsAssignment_0_1_0_6_0_0(), "rule__CompositeEntity__PortsAssignment_0_1_0_6_0_0");
					put(grammarAccess.getCompositeEntityAccess().getPortsAssignment_0_1_0_6_0_1_1(), "rule__CompositeEntity__PortsAssignment_0_1_0_6_0_1_1");
					put(grammarAccess.getCompositeEntityAccess().getPortsAssignment_0_1_0_6_2_0(), "rule__CompositeEntity__PortsAssignment_0_1_0_6_2_0");
					put(grammarAccess.getCompositeEntityAccess().getPortsAssignment_0_1_0_6_2_1_1(), "rule__CompositeEntity__PortsAssignment_0_1_0_6_2_1_1");
					put(grammarAccess.getCompositeEntityAccess().getSuperEntityAssignment_0_1_1_1(), "rule__CompositeEntity__SuperEntityAssignment_0_1_1_1");
					put(grammarAccess.getCompositeEntityAccess().getPortsAssignment_1(), "rule__CompositeEntity__PortsAssignment_1");
					put(grammarAccess.getCompositeEntityAccess().getAttributesAssignment_2(), "rule__CompositeEntity__AttributesAssignment_2");
					put(grammarAccess.getCompositeEntityAccess().getEntitiesAssignment_4(), "rule__CompositeEntity__EntitiesAssignment_4");
					put(grammarAccess.getCompositeEntityAccess().getRelationsAssignment_5(), "rule__CompositeEntity__RelationsAssignment_5");
					...
					put(grammarAccess.getVariableAccess().getDisplayNameAssignment_3(), "rule__Variable__DisplayNameAssignment_3");
					put(grammarAccess.getVariableAccess().getValueExpressionAssignment_4_1(), "rule__Variable__ValueExpressionAssignment_4_1");
					put(grammarAccess.getActorParameterAccess().getTypeAssignment_0(), "rule__ActorParameter__TypeAssignment_0");
					put(grammarAccess.getActorParameterAccess().getNameAssignment_1(), "rule__ActorParameter__NameAssignment_1");
					put(grammarAccess.getActorParameterAccess().getDisplayNameAssignment_2(), "rule__ActorParameter__DisplayNameAssignment_2");
					put(grammarAccess.getActorParameterAccess().getValueExpressionAssignment_3_1(), "rule__ActorParameter__ValueExpressionAssignment_3_1");
					put(grammarAccess.getPortAccess().getAttributesAssignment_1_1(), "rule__Port__AttributesAssignment_1_1");
					put(grammarAccess.getAnnotationAttributeAccess().getTypeAssignment_1(), "rule__AnnotationAttribute__TypeAssignment_1");
					put(grammarAccess.getAnnotationAttributeAccess().getNameAssignment_2(), "rule__AnnotationAttribute__NameAssignment_2");
					put(grammarAccess.getAnnotationAttributeAccess().getValueExpressionAssignment_4(), "rule__AnnotationAttribute__ValueExpressionAssignment_4");
					put(grammarAccess.getPlainPortAccess().getNameAssignment_2(), "rule__PlainPort__NameAssignment_2");
					put(grammarAccess.getPlainPortAccess().getDisplayNameAssignment_3(), "rule__PlainPort__DisplayNameAssignment_3");
					put(grammarAccess.getTypedIOPortAccess().getIoKindAssignment_0(), "rule__TypedIOPort__IoKindAssignment_0");
					put(grammarAccess.getTypedIOPortAccess().getTypeAssignment_1(), "rule__TypedIOPort__TypeAssignment_1");
					put(grammarAccess.getTypedIOPortAccess().getRateAssignment_2_1(), "rule__TypedIOPort__RateAssignment_2_1");
					put(grammarAccess.getTypedIOPortAccess().getMultiportAssignment_3(), "rule__TypedIOPort__MultiportAssignment_3");
					put(grammarAccess.getTypedIOPortAccess().getNameAssignment_4(), "rule__TypedIOPort__NameAssignment_4");
					put(grammarAccess.getTypedIOPortAccess().getDisplayNameAssignment_5(), "rule__TypedIOPort__DisplayNameAssignment_5");
					...
					put(grammarAccess.getRelationAccess().getSourcePortAssignment_1(), "rule__Relation__SourcePortAssignment_1");
					put(grammarAccess.getRelationAccess().getTargetPortsAssignment_3(), "rule__Relation__TargetPortsAssignment_3");
					put(grammarAccess.getRelationAccess().getTargetPortsAssignment_4_1(), "rule__Relation__TargetPortsAssignment_4_1");
					put(grammarAccess.getRelationAccess().getNameAssignment_5_1(), "rule__Relation__NameAssignment_5_1");
					put(grammarAccess.getRelationAccess().getDisplayNameAssignment_5_2(), "rule__Relation__DisplayNameAssignment_5_2");
					put(grammarAccess.getAbstractEntityActorImplAccess().getEntityAssignment_1_0_1(), "rule__AbstractEntityActorImpl__EntityAssignment_1_0_1");
					put(grammarAccess.getAbstractEntityActorImplAccess().getRefAssignment_1_1_1(), "rule__AbstractEntityActorImpl__RefAssignment_1_1_1");
					put(grammarAccess.getCaltropActorImplAccess().getDeclarationsAssignment_1(), "rule__CaltropActorImpl__DeclarationsAssignment_1");
					put(grammarAccess.getCaltropActorImplAccess().getInitActionsAssignment_2_0_0(), "rule__CaltropActorImpl__InitActionsAssignment_2_0_0");
					put(grammarAccess.getCaltropActorImplAccess().getActionsAssignment_2_0_1(), "rule__CaltropActorImpl__ActionsAssignment_2_0_1");
					put(grammarAccess.getCaltropActorImplAccess().getActionsAssignment_2_1(), "rule__CaltropActorImpl__ActionsAssignment_2_1");
					put(grammarAccess.getStateVariableAccess().getConstantAssignment_0_0(), "rule__StateVariable__ConstantAssignment_0_0");
					put(grammarAccess.getStateVariableAccess().getTypeAssignment_1(), "rule__StateVariable__TypeAssignment_1");
					put(grammarAccess.getStateVariableAccess().getNameAssignment_2(), "rule__StateVariable__NameAssignment_2");
					put(grammarAccess.getStateVariableAccess().getValueExpressionAssignment_3_1(), "rule__StateVariable__ValueExpressionAssignment_3_1");
					...
					put(grammarAccess.getFireActionAccess().getBodyExpressionAssignment_7_1(), "rule__FireAction__BodyExpressionAssignment_7_1");
