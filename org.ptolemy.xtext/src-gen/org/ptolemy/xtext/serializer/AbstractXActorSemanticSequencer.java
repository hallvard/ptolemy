...
public abstract class AbstractXActorSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private XActorGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ActorPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ActorPackage.ACTOR_REF:
				if(context == grammarAccess.getActorRefRule()) {
			...
			case ActorPackage.TYPED_COMPOSITE_ACTOR:
				if(context == grammarAccess.getCompositeEntityRule() ||
				   context == grammarAccess.getEntityRule()) {
					sequence_CompositeEntity(context, (TypedCompositeActor) semanticObject); 
					return; 
				}
				else break;
			...
			case CaltropPackage.EXPRESSION_CHANNEL_SELECTOR:
				if(context == grammarAccess.getChannelSelectorRule() ||
				   context == grammarAccess.getExpressionChannelSelectorRule()) {
					sequence_ExpressionChannelSelector(context, (ExpressionChannelSelector) semanticObject); 
					return; 
				}
				else break;
			...
			case CaltropPackage.INPUT_PATTERN:
				if(context == grammarAccess.getInputPatternRule()) {
			...
			case CaltropPackage.KEYWORD_CHANNEL_SELECTOR:
				if(context == grammarAccess.getChannelSelectorRule() ||
				   context == grammarAccess.getKeywordChannelSelectorRule()) {
					sequence_KeywordChannelSelector(context, (KeywordChannelSelector) semanticObject); 
					return; 
				}
				else break;
			case CaltropPackage.OUTPUT_ACTION:
				if(context == grammarAccess.getInitActionRule()) {
					sequence_InitAction(context, (OutputAction) semanticObject); 
					return; 
				}
				else break;
			case CaltropPackage.OUTPUT_PATTERN:
				if(context == grammarAccess.getOutputPatternRule()) {
			...
			case CaltropPackage.TYPED_INPUT_PORT:
				if(context == grammarAccess.getTypedInputPortRule()) {
					sequence_TypedInputPort(context, (TypedInputPort) semanticObject); 
					return; 
				}
				else break;
			...
			case XbasePackage.XBINARY_OPERATION:
				if(context == grammarAccess.getXAdditiveExpressionRule() ||
				   ...
				   context == grammarAccess.getXRelationalExpressionAccess().getXInstanceOfExpressionExpressionAction_1_0_0_0_0() ||
				   context == grammarAccess.getXUnaryOperationRule()) {
					sequence_XAdditiveExpression_XAndExpression_XAssignment_XEqualityExpression_XMultiplicativeExpression_XOrExpression_XOther2OperatorExpression_XOtherOperatorExpression_XRelationalExpression(context, (XBinaryOperation) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (many?='at*'? keyExpressions+=XExpression keyExpressions+=XExpression*)
	 */
	protected void sequence_ExpressionChannelSelector(EObject context, ExpressionChannelSelector semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_KeywordChannelSelector(EObject context, KeywordChannelSelector semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, CaltropPackage.Literals.KEYWORD_CHANNEL_SELECTOR__KEYWORD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, CaltropPackage.Literals.KEYWORD_CHANNEL_SELECTOR__KEYWORD));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getKeywordChannelSelectorAccess().getKeywordChannelSelectorKeywordEnumRuleCall_1_0(), semanticObject.getKeyword());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_ParameterBinding(EObject context, ParameterBinding semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_TypedAtomicActor(EObject context, TypedAtomicActor semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 * Constraint:
	 *     (
	 *         (leftOperand=XOther2OperatorExpression_XBinaryOperation_1_0_0_0 feature=[JvmIdentifiableElement|OpOther2] rightOperand=XCastedExpression) | 
	...
	/**
	 * Constraint:
	 *     (feature=[JvmIdentifiableElement|OpUnary] operand=XOther2OperatorExpression)
	 */
